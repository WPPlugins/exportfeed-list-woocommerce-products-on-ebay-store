...
<div class="wrap cpf-page">
    <?php
    $cpf_ebay_accounts = EBCPF_eBayAccount::getAll();
    $cpf_default_account = EBCPF_eBayAccount::getDefaultAccount();
            ...
            <div id="postbox-container-1" class="postbox-container">
                <div id="side-sortables" class="meta-box">
                    ...
                    <div class="postbox" id="submitdiv">
                        ...
                        <h3><span><?php echo __('Account Status ', 'ebcpf-exportfeed-ebay-strings'); ?></span></h3>
                        <div class="inside">
                                ...
                                <div id="misc-publishing-actions">
                                    <div class="misc-pub-section">
                                        <?php if (sizeof($cpf_ebay_accounts) == 0) : ?>
                                            <p><?php echo __('Cart Product Feed is not linked to your eBay account yet. ', 'ebcpf-exportfeed-ebay-strings') ?></p>
                                        <?php elseif (!$cpf_default_account) : ?>
                                            <p><?php echo __('You need to select a default account. ', 'ebcpf-exportfeed-ebay-strings') ?></p>
                                        <?php else : ?>
                                            <p>
                                                <?php echo sprintf(__('Your default account is <b>%s</b>. ', 'ebcpf-exportfeed-ebay-strings '), EBCPF_eBayAccount::getAccountTitle($cpf_default_account)) ?>
                                            </p>
                                            <p>
                                                <?php echo __('The default account will always be used by Cart Product Feed .', 'ebcpf-exportfeed-ebay-strings') ?>
                                            </p>
                                        <?php endif; ?>
                ...
                <div class="meta-box-sortables ui-sortable">
                    ...
                    <?php if (sizeof($cpf_ebay_accounts) == 0) : ?>
                        ...
                        <div class="postbox" id="AuthSettingsBox">
                            <h3 class="hndle"><span><?php echo __('Welcome ', 'ebcpf-exportfeed-ebay-strings') ?></span></h3>
                            <div class="inside">
                                <p>
                                    <strong><?php echo __('Before you can begin listing your products on eBay, you need to set up your eBay account. ', 'ebcpf-exportfeed-ebay-strings') ?></strong>
                                </p>
                                <p>
                                    <?php echo __('Please select the eBay site you want to use and follow the instructions that will appear below. ', 'ebcpf-exportfeed-ebay-strings') ?>
                                </p>
                            </div>
                        </div>
                    ...
                    <?php else: ?>
                        ...
                        <form id="accounts-filter" method="post" action="">
                            <!-- For plugins, we also need to ensure that the form posts back to our current page -->
                            <input type="hidden" name="page" value="<?php echo $_REQUEST['page'] ?>"/>
                            <!-- Now we can render the completed list table -->
                            <?php ebcpf_display_accounts_table($cpf_ebay_accounts); ?>
                        </form>
        ...
        jQuery(document).ready(
            function () {
                ...
                jQuery('a.delete').on('click', function () {
                    return confirm("<?php echo __('Are you sure you want to remove this account from Cart Product List? ', 'ebcpf-exportfeed-ebay-strings') ?>");
                });
                // ask again before deleting items
    ...
    function ebcpf_display_accounts_table($cpf_ebay_accounts)
    {
        $html = '';
        ...
        $action_url = get_admin_url() . 'admin.php?page=ebcpf-ebay-admin&action=eBay_action&id=' .$records->id;
         $html .= '<tr><td>' . $records->title . ' <div class="row-actions"><span class="id">ID: '.$records->id.' | </span><span class="delete">
         <a href="'.get_admin_url() . 'admin.php?page=ebcpf-ebay-admin&action=delete_account&id=' .$records->id.'&task=0" title="Delete this account" rel="permalink" '.$disabled.'>Delete</a> | </span>
         <span class="make_default"> <a href="'.get_admin_url() . 'admin.php?page=ebcpf-ebay-admin&action=make_account_default&id=' .$records->id.'&task=1" title="Make this account Default" rel="permalink" '.$disabled.'>Make Default</a></span></div></td><td>' . $records->user_name . ' </td><td>' . $records->site_code . ' </td><td>' . $records->valid_until . ' </td>';
        }
        $html .= ' </tbody>';
        $html .= ' <tfoot>
            <tr>
