...
class EBCPF_License {
	...
	protected $strLicenseKey = 'ebcpf_licensekey';
	protected $strLocalKey = 'ebcpf_localkey';
	protected $strLicenseKeyOld = 'ebcpf_xml_licensekey';
	protected $strLocalKeyOld = 'ebcpf_xml_localkey';
	protected $strRapidcartToken = 'ebcpf_rapidcarttoken';
	...
	function __construct($debug = false) {
		...
		$this->results['checkEBCPF_md5x'] = new EBCPF_md5x( $licensekey . $localkey, $this->results );
	...
	function unregisterAll() {
		...
		$pfcore->settingDelete('ebcpf_licensekey');
		$pfcore->settingDelete('ebcpf_localkey');
		$pfcore->settingDelete('ebcpf_rapidcarttoken');
		$pfcore->settingDelete('ebcpf_xml_licensekey');
		$pfcore->settingDelete('ebcpf_xml_localkey');
		$pfcore->settingDelete('ebcpf_gts_licensekey');
		$pfcore->settingDelete('ebcpf_gts_localkey');
		$pfcore->settingDelete('ebcpf_fv_licensekey');
		$pfcore->settingDelete('ebcpf_fv_localkey');
	}
...
class EBCPF_LicenseGTS extends EBCPF_License {
	...
	function __construct() {
		...
		$this->strLicenseKey = 'ebcpf_gts_licensekey';
		$this->strLocalKey = 'ebcpf_gts_localkey';
		parent::__construct();
	}
}

class EBCPF_LicenseFV extends EBCPF_License {

	function __construct() {
		$this->strErrorMsgMain = '- Register for the pro version to get full functionality: <a target=\'_blank\' href = \'http://exportfeed.com/\'>exportfeed.com</a> ';
		$this->strLicenseKey = 'ebcpf_fv_licensekey';
		$this->strLocalKey = 'ebcpf_fv_localkey';
		$this->strLocalKeyOld = '';
		$this->strLocalKeyOld = '';
		parent::__construct();
	}
