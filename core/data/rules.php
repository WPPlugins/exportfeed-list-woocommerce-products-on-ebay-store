...
class EBCPF_FeedRule {

	public $enabled = true;
	public $name = '';
	public $order = 200; //200 ~ EBCPF_ActionBeforeFeed, therefore don't assign order > 299 (300 ~ EBCPF_ActionAfterFeed)
...
class EBCPF_FeedRuleConcat extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleDescription extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleDiscount extends EBCPF_FeedRule {
...
//***********************************************************
class EBCPF_FeedRuleFindAndSet extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleGooglecombotitle extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleGoogleexacttitle extends EBCPF_FeedRule {
...
//***********************************************************
class EBCPF_FeedRulePricestandard extends EBCPF_FeedRule {
...
class EBCPF_FeedRulePricerounding extends EBCPF_FeedRule {
...
class EBCPF_FeedRulePricedecimalseparator extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleNoVariations extends EBCPF_FeedRule {
...
//all categories
		if (in_array('*', $this->parameters)) {
			$this->parent_feed->addAttributeDefault('allcat', $this_parameter, 'EBCPF_CatVar');
		}
//individual categories
		else {			
			foreach($this->parameters as $this_parameter)
				if ( is_numeric($this_parameter) ) 				
					$this->parent_feed->addAttributeDefault('xVar', $this_parameter, 'EBCPF_CatVar');
		}
	}
}

class EBCPF_FeedRulePricegroup extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleRemoveEmptyAttributes extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleShipping extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleStatusstandard extends EBCPF_FeedRule {
...
class EBCPF_FeedRulePos extends EBCPF_FeedRule {
// public function initialize() {
// 	$this->order = 190;
// }
	public function process($product) {
...
//***********************************************************
class EBCPF_FeedRuleSetAll extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleStrlen extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleStrReplace extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleSubstr extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleTax extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleValidalways extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleWeightunit extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleDimensionunit extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleStrip_tags extends EBCPF_FeedRule {
...
//***********************************************************
class EBCPF_FeedRuleRemoveAttributeCondition extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleCSVStandard extends EBCPF_FeedRule {
...
***********/
class EBCPF_FeedRuleStrictAttribute extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleFindIdentifiers extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleGetSubcategory extends EBCPF_FeedRule {
...
class EBCPF_FeedRuleGetPipedImages extends EBCPF_FeedRule {
